// This file is taken from the Datadog repository - https://github.com/DataDog/datadog-serverless-functions/blob/master/azure/activity_logs_monitoring/index.js
...
const DD_SERVICE = process.env.DD_SERVICE || 'log-forwarder';
const DD_SOURCE = process.env.DD_SOURCE || 'azure';
const DD_SOURCE_CATEGORY = process.env.DD_SOURCE_CATEGORY || 'non-prod';
